...
class CartAdmin(admin.ModelAdmin):
    ...
    list_display = ["id", "user", "order", "product", "price", "ordered_quantity", ] # https://docs.djangoproject.com/en/5.0/ref/contrib/admin/#django.contrib.admin.ModelAdmin.list_display
